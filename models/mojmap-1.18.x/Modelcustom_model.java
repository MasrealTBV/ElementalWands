	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(0, 10)
						.addBox(-2.0F, -4.0F, -3.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(-1.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r1 = bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(15, 5).addBox(-8.5F, -9.0F, 10.8F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(-0.2F)),
				PartPose.offsetAndRotation(8.0F, -2.0F, -14.0F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r2 = bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(15, 5).addBox(-9.9218F, 0.4615F, 11.537F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(-0.2F)),
				PartPose.offsetAndRotation(9.9218F, -1.9615F, -13.537F, 0.0F, 0.0F, 0.3927F));

		PartDefinition cube_r3 = bb_main.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(15, 5).addBox(-9.4218F, -7.0385F, 11.537F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(-0.2F)),
				PartPose.offsetAndRotation(9.9218F, -1.9615F, -13.537F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r4 = bb_main.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 20).addBox(0.0F, -3.0F, -3.0F, 0.0F, 6.0F, 6.0F,
