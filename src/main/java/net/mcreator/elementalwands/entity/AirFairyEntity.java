...
public class AirFairyEntity extends PathfinderMob {
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("old_growth_birch_forest"),
			...
			new ResourceLocation("windswept_forest"), new ResourceLocation("jungle"), new ResourceLocation("swamp"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(ElementalWandsModItems.AIR_SHARD.get()));
	}
